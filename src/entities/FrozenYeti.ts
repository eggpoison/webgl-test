...
class FrozenYeti extends Entity {
   ...
   constructor(position: Point, hitboxes: ReadonlySet<CircularHitbox | RectangularHitbox>, id: number, renderDepth: number, attackType: FrozenYetiAttackType, attackStage: number, stageProgress: number) {
      ...
      this.attachRenderPart(new RenderPart(
         ...
         FrozenYeti.SIZE,
         FrozenYeti.SIZE,
         getGameObjectTextureIndex("entities/frozen-yeti/frozen-yeti.png"),
         1,
         0
      ));
      ...
      this.headRenderPart = new RenderPart(
         ...
         FrozenYeti.HEAD_SIZE,
         getGameObjectTextureIndex("entities/frozen-yeti/frozen-yeti-head.png"),
         2,
         0
      );
      ...
      for (let i = 0; i < 2; i++) {
         const paw = new RenderPart(
            ...
            FrozenYeti.PAW_SIZE,
            FrozenYeti.PAW_SIZE,
            getGameObjectTextureIndex("entities/frozen-yeti/frozen-yeti-paw.png"),
            0,
            0
         );
