...
export function renderForcefield(): void {
   ...
   if (Camera.minVisibleRenderChunkX < 0) {
      const x1 = -SettingsConst.EDGE_GENERATION_DISTANCE * SettingsConst.TILE_SIZE;
      const x2 = 0;
      const y1 = 0;
      const y2 = SettingsConst.BOARD_UNITS;
   ...
   if (Camera.maxVisibleRenderChunkX >= WORLD_RENDER_CHUNK_SIZE) {
      const x1 = SettingsConst.BOARD_UNITS;
      const x2 = SettingsConst.BOARD_UNITS + SettingsConst.EDGE_GENERATION_DISTANCE * SettingsConst.TILE_SIZE;
      const y1 = 0;
      const y2 = SettingsConst.BOARD_UNITS;
   ...
   if (Camera.minVisibleRenderChunkY < 0) {
      const x1 = 0;
      const x2 = SettingsConst.BOARD_UNITS;
      const y1 = -SettingsConst.EDGE_GENERATION_DISTANCE * SettingsConst.TILE_SIZE;
      const y2 = 0;
   ...
   if (Camera.maxVisibleRenderChunkY >= WORLD_RENDER_CHUNK_SIZE) {
      const x1 = 0;
      const x2 = SettingsConst.BOARD_UNITS;
      const y1 = SettingsConst.BOARD_UNITS;
      const y2 = SettingsConst.BOARD_UNITS + SettingsConst.EDGE_GENERATION_DISTANCE * SettingsConst.TILE_SIZE;
